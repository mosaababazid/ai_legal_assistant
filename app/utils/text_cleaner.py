...
def clean_extracted_text(text: str) -> str:
    """
    Performs lightweight cleanup of OCR/PDF extracted text.

    This primarily removes common boilerplate and personal data patterns (names, addresses,
    long numbers) to improve downstream summarization and retrieval quality.
    """
    lines = text.split("\n")
    cleaned_lines = []
    skip_keywords = [
